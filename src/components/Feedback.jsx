  ...
  return (
    <article>
      <div className="comment border border-green rounded-[45px] p-[30px] lg:p-12 relative">
        ...
        <div className="comment-feedback w-10 h-10 border-r border-b border-green absolute -bottom-[20px] left-24 rotate-45 bg-dark" />
      </div>
      <div className="info mt-11 ml-[118px]">
